...
public abstract class GUI {
	...
	/**
	 * Defines the different actions applied when the appropriate button is pressed
	 * when the set method is called
	 */
	
	public enum Action {
		ASTAR, ARTIC, DIST, TIME
	};
	...
	/**
	 * Is called when Time or Distance is selected a different output will be presented
	 */
	
	protected abstract void onSet(Action a);
	...
	/**
	 * Special load button for the restrictions file
	 * @param restrictions
	 */
	protected abstract void onLoadR(File restrictions);
	...
	private void initialise() {
		...
		JButton astar = new JButton("Astar");
		...
		JButton artic = new JButton("Artic");
		artic.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				onSet(Action.ARTIC);
				redraw();
			}
